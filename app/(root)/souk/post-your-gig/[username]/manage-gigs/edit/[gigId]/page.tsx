...
import { TitleEditor } from "@/components/souk/title-editor";
            ...
            <div className="space-y-12 2xl:px-64 xl:px-36 md:px-12 px-12 ">
                <div className="flex justify-end pr-2 space-x-2">
                    ...
                    <Link href={`/${gig.seller.username}/${gig._id}`}>
                        <Button disabled={removePending} variant={"ghost"}>
                            Preview
                        </Button>
                    </Link>
                    <Button disabled={removePending} variant={"destructive"} onClick={onDelete}>
                        Delete
                    </Button>
                </div>
